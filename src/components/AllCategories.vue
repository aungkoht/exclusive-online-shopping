<template>
  <div class="d-flex justify-content-center mt-5 allCategories">
   <div class="row">
      ...
      <!-- watch -->
      <div class="col-3 col-lg-2 iconCont">
         <i class="fa-regular fa-clock" style="font-size:36px; font-weight:lighter"></i>
         <div class="mt-1">Smart watches</div>
      </div>
      <!-- camera -->
      <div class="col-3 col-lg-2 iconCont">
         <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 56 56" fill="none">
