<template>
  <div class="footer">
    <div class="sectionsContainer d-flex my-5">
         <div class="section d-flex flex-column ms-3">
            <div class=" header">Exclusive</div>
            <div class="text-light subscribe">Subscribe</div>
            <div class=" bodyText">Get 10% off your first order</div>
            <div class="d-flex flex-row mt-5 mailContainer">
               <input class="sendEmail" type="text" placeholder="Enter your email">
         ...
         <div class="section d-flex flex-column ms-3">
               ...
               <div class="bodyText ">111 Bijoy sarani, Dhaka,  DH 1515, Bangladesh.</div>
               <div class="bodyText">exclusive@gmail.com</div>
               <div class="bodyText">+88015-88888-9999</div>
         </div>
         <div class="section d-flex flex-column ms-3">
            <div class="header">Quick Link</div>
            <div class="bodyText">My Account</div>
            <div class="bodyText">Login/ Register</div>
            <div class="bodyText">Cart</div>
            <div class="bodyText">Wishlist</div>
            <div class="bodyText">Shop</div>
         </div>
         <div class="section d-flex flex-column ms-3">
            <div class="header">My Account</div>
            <div class="bodyText">Privacy Policy</div>
            <div class="bodyText">Terms of Use</div>
            <div class="bodyText">FAQ</div>
            <div class="bodyText">Contact</div>
         </div>
         <div class="section d-flex flex-column downloadApp ">
            <div class="header">Download App</div>
            <div class="save">Save $3 with App New User Only</div>
            <div class="d-flex flex-row getappContainer">
                    <div class="QRCont">
                        <img class="QRCode" src="https://s3-alpha-sig.figma.com/img/9913/87c0/5dd6d44594e01b675513068803e2426d?Expires=1691366400&Signature=eZbYtn5TEcRvvjzOpyUXXXgzxb0ogkBvRcWC5PwbV11WixV5tXFm6DjUrU9TRi2lSet817OG2nCpVtm~CWL3RJ9-vAsanBLHhRxNhK6QBpU8r7x7~NlqYS3-GduFnpMPiSqUhaf14qzxgJffb6mG~L8QQ-SD8OHaHxEhNNoR6nQEX2eI3uatO9fu3N1DI7qQm8KQqUdtbT2VlpA5QAhunsdfhbCwAooiRGwAcpgPW6yNS3MGUNxQy64JygJzOCDpdiQgV~VVVoX3yMofdtRgayMHLYOtT4sM0RjgXB39FE8DUOUZIWnvWWQS3cpAetUqyAsHWnLQRGaIvxJtu6fb9Q__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="">
                    </div>
                    <div class="d-flex flex-column ">
                       <div class="playstoreCon">
                         <img class="playstore" src="https://s3-alpha-sig.figma.com/img/a61d/4c71/10b18ab55a1e1a07ebf54a46ebb07284?Expires=1691366400&Signature=ZSB-CzqO3bqsvAmwjZk1aA2DTbP-N~lO1fCkE0XB9-b7rZpiC~fKoXkJs7OHWTlITab3sie1CwgrjoibUwkFNI0uJUT-fdS6-JDGfftGE4aMDg8yE3QH0dKbF~ze1ntUn~gnx7fI-wjNTtTyehd64S-XKAilHhUWZ1z3NsSaX-ITLxXG~1PiwwPUzmu8n1ll7Sr3FA~L939oqy4udhHjCu0RmRFpRN5g1UCekOpOPqTX0iaejg52RSoN2fpuarbpWg81saV4Pa7R6snHgIBwt3ouJbzqxki8NETnnnJwXBasCBoy80v8d0AFjHP2Q7rJaNW0hFESlwF472eRYFwcHQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="">
                       </div>
                        <div class="appstoreCon">
                              <img class="appstore" src="https://s3-alpha-sig.figma.com/img/3893/2d5a/ccb54c528f9bcf326ca48ea29bd6d890?Expires=1691366400&Signature=Gb55jCPOQ2AQqlgjuMts48owTziGVG1gbV-WQ5cUdRYfJ-6ytLuIUwcpdmzDBqedNDFR17g-d4mJCQAOS5WyABYEqSynGqLr46NXr9No9OdWmRvRsrsWoEB0W3GZtklCsnM~19MfVM2T7qcrnwvsm8xdUkhYiqI3YFX2-KphGsjlwAFzxm1mEc86Afv0FRkgY6wfgZpr~gmtM0i4UEcoX6wtFxWnUEx26llMI4AiA3q~PAB14kuWQZGOld3OPR8UHnp-5L79lN9QAZDja1LqmRZk76klDNgsoCRJrbEZNlrEe1b~Qph7qIwOCuNJgpPd4rKNGlUlAB7R7QyB-6WQQg__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="">
                        </div>
                    </div>
            </div>
            <div class="d-flex flex-row socials mt-2">
               <div class="facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<path d="M9.50002 18.3332C14.1024 18.3332 17.8334 14.6022 17.8334 9.99984C17.8334 5.39746 14.1024 1.6665 9.50002 1.6665C4.89765 1.6665 1.16669 5.39746 1.16669 9.99984C1.16669 14.6022 4.89765 18.3332 9.50002 18.3332Z" stroke="#aaa" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12 8.14799C12 8.14799 10.9706 6.6665 9.25492 6.6665C7.53924 6.6665 6.16669 8.14799 6.16669 9.99984C6.16669 11.8517 7.53924 13.3332 9.25492 13.3332C10.9706 13.3332 12 11.8517 12 11.8517" stroke="#aaa" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
