<template>
  <div class="d-flex  justify-content-center align-items-center containers ">
      <div class=" carContainer col-12 col-lg-4 mt-5">
            ...
            <circle cx="40.5" cy="40" r="29" fill="black"/>
               <!-- car -->
            <div> <svg class="car" xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
   <g clip-path="url(#clip0_946_335)">
   ...
   <defs>
      <clipPath id="clip0_946_335">
         <rect width="40" height="40" fill="white" transform="translate(0.5)"/>
            ...
            <div class="bodyText">Free delivery for all orders over $140</div>
      </div>
      <div class="customerService col-12 col-lg-4 mt-5">
              <svg xmlns="http://www.w3.org/2000/svg" width="81" height="80" viewBox="0 0 81 80" fill="none">
               <path opacity="0.3" d="M80.5 40C80.5 62.0914 62.5914 80 40.5 80C18.4086 80 0.5 62.0914 0.5 40C0.5 17.9086 18.4086 0 40.5 0C62.5914 0 80.5 17.9086 80.5 40ZM11.4071 40C11.4071 56.0675 24.4325 69.0929 40.5 69.0929C56.5675 69.0929 69.5929 56.0675 69.5929 40C69.5929 23.9325 56.5675 10.9071 40.5 10.9071C24.4325 10.9071 11.4071 23.9325 11.4071 40Z" fill="#2F2E30"/>
               <circle cx="40.5" cy="40" r="29" fill="black"/>
               </svg>
               ...
               <div class="bodyText">Friendly 24/7 customer support</div>
      </div>
      <div class="moneyContainer col-12 col-lg-4 mt-5">
              <svg xmlns="http://www.w3.org/2000/svg" width="81" height="80" viewBox="0 0 81 80" fill="none">
               <path opacity="0.3" d="M80.5 40C80.5 62.0914 62.5914 80 40.5 80C18.4086 80 0.5 62.0914 0.5 40C0.5 17.9086 18.4086 0 40.5 0C62.5914 0 80.5 17.9086 80.5 40ZM11.4071 40C11.4071 56.0675 24.4325 69.0929 40.5 69.0929C56.5675 69.0929 69.5929 56.0675 69.5929 40C69.5929 23.9325 56.5675 10.9071 40.5 10.9071C24.4325 10.9071 11.4071 23.9325 11.4071 40Z" fill="#2F2E30"/>
               <circle cx="40.5" cy="40" r="29" fill="black"/>
            </svg>
            <div>
                  <svg class="money" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
...
<style scoped>
   ...
   .carContainer, .customerService, .moneyContainer{
      position: relative;
      display: flex;
